// // mostrar las tablas de multiplicar del 1 al, 9 por la consola
//  for (let i = 0; i < 10; i++) {
//     for (let j = 0; j < 10; j++) {   
//        let result = i*j;  
...
// recrea la funsion parseFloat( ) de manera que agafi els numeros encara que hi hagi
//lletres abans i accepti com a separardor decimal els simbols
//"," , ":" , "." y "'". p.e. "hola89'234" ha de tornar 89.234,  "43'35adeu", ha de tornar "43.35", "amor45.9odi" ha de tornar 45.9. "234.1234.25.5" ha de tornar 234.1234.

// 3.-  

// crea una funcion que agafi una string i que torni una paraula aleatroria contiguada en ella (sense usar arrays)

// let frase = prompt("introduzca la frase");
// let random = Math.random();
//     random = parseFloat(random);
//     console.log(random);
// function palabra_aleatoria (x){
...
oracion = prompt("Introduzca la oracion al Seyor")
function letra () {
   
    
    for (let i = 0; i < oracion.length; i++) {
        //const element = oracion[i];
        if (oracion[i] != " ") {
            let cadena =  cadena + oracion[i];
        }
        else {
            i++
        }    
